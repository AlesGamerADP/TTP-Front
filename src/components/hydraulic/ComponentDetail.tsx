      ...
      <header className="app-subheader sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-3 py-4">
              ...
              <div className="flex flex-col gap-2">
                <Button
                  ...
                  onClick={() => {
                    const url = componentsApi.exportHistory(component.id, 'csv');
                ...
                {canDelete && (
                  <Button
                    variant="ghost"
                    size="sm"
                    className="header-action-button header-action-button--danger w-full justify-center font-medium h-9 rounded-md text-sm"
          ...
          <ConfirmDialog
            ...
            description={`Esta acción no se puede deshacer. Se eliminará permanentemente el componente ${component.serial} (${component.servicio_principal}) y todos sus datos asociados, incluyendo documentos y eventos del historial.`}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {component.id_cotizacion && (
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">Nº de Cotización</label>
                      <p className="text-base font-medium break-all sm:break-words">{component.id_cotizacion}</p>
                    </div>
                  )}
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-base break-words">{component.servicio_principal}</p>
                  </div>
                  <div>
                  ...
                  {component.atencion_persona && (
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">Atención (Persona de Contacto)</label>
                      <p className="text-base break-words">{component.atencion_persona}</p>
                    </div>
                  )}
                  {component.hoja_evaluacion_he && (
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">Hoja Evaluación HE</label>
                      <p className="text-base font-medium break-words">{component.hoja_evaluacion_he}</p>
                    </div>
                  )}
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">Item Nro</label>
                    <p className="text-base break-words">{component.item_nro ?? 1}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">Cantidad</label>
                    <p className="text-base break-words">{component.cantidad ?? 1}</p>
                  </div>
                  {component.nro_actividad && (
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">Nro Actividad</label>
                      <p className="text-base break-words">{component.nro_actividad}</p>
                    </div>
                  )}
                  {component.descripcion_actividad && (
                    <div className="md:col-span-2">
                      <label className="text-sm font-medium text-muted-foreground">Descripción Actividad</label>
                      <p className="text-base break-words">{component.descripcion_actividad}</p>
                    </div>
                  )}
                  <div>
                ...
                {component.solicitud_general && (
                  <div className="pt-2">
                    <label className="text-sm font-medium text-muted-foreground">Solicitud General</label>
                    <p className="text-base break-words whitespace-pre-wrap">{component.solicitud_general}</p>
                  </div>
                )}
              </CardContent>
            </Card>
